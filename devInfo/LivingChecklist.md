...
- [ ] Tenant settings page (basic org info, feature toggles) — In 1.0 scope
  ...
  - [x] Tenant switch blank-state regression resolved; refresh rotation bridge shares rotated cookies so new tenant data hydrates immediately and now persists rotations for up to one hour (2025-09-26).
