...
- Last updated: 2025‑09‑20 (Story 4 Phase 2: Removed deprecated `MembershipRole` enum and obsolete convergence test; flags-only authorization & management complete. Prior: deprecated legacy invite role field, numeric roles bitmask support, admin gating tightening, removal of web fallback, avatar pipeline simplification, denomination presets, profile/guardrails, change password, tenant settings/logo, Node 20 testing.)
