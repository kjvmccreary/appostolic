...
- Last updated: 2025‑09‑20 (Stories 7 & 8 complete: legacy MembershipRole column removed; bitmask constraints (nonzero + valid subset) added; Story 9 doc updates in progress with upgrade/rollback guide added. Prior: removed deprecated MembershipRole enum and obsolete convergence test; flags-only authorization & management complete; avatar pipeline simplification; denomination presets; profile/guardrails; change password; tenant settings/logo; Node 20 testing.)
