...
export default function ShepherdStep2({
  searchParams,
}: {
  ...
  return (
    <main className="p-4 sm:p-6 lg:p-8 space-y-4">
      ...
      <section className="space-y-2">
        <h1 className="text-ink text-lg font-semibold">Select Audience</h1>
        <p className="text-muted text-sm">
          Who are you speaking to? Choose one or more audience profiles.
        </p>
      </section>
      <div className="flex justify-between">
        <Link
          href={`/shepherd/step1${q ? `?${q}` : ''}`}
