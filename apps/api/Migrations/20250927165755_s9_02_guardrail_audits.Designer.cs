...
namespace Appostolic.Api.Migrations
{
    ...
    [Migration("20250927165755_s9_02_guardrail_audits")]
    partial class s9_02_guardrail_audits
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Appostolic.Api.Domain.Guardrails.GuardrailPolicyAudit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<JsonDocument>("DiffSummary")
                        .HasColumnType("jsonb")
                    ...
                    b.Property<Guid?>("SystemPolicyId")
                        .HasColumnType("uuid")
                        .HasColumnName("system_policy_id");

                    b.Property<Guid?>("TenantId")
                        .HasColumnType("uuid")
                        .HasColumnName("tenant_id");

                    b.Property<Guid?>("TenantPolicyId")
                        .HasColumnType("uuid")
                        .HasColumnName("tenant_policy_id");
                    ...
                    b.HasIndex("TenantId")
                        .HasDatabaseName("ix_guardrail_policy_audits_tenant");

                    b.HasIndex("TenantPolicyId")
                        .HasDatabaseName("ix_guardrail_policy_audits_tenant_policy");

                    b.HasIndex("Scope", "OccurredAt")
                        .HasDatabaseName("ix_guardrail_policy_audits_scope");
            ...
            modelBuilder.Entity("Appostolic.Api.Domain.Guardrails.GuardrailPolicyAudit", b =>
                {
                    b.HasOne("Appostolic.Api.Domain.Guardrails.GuardrailDenominationPolicy", null)
                        .WithMany()
                        .HasForeignKey("PresetId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Appostolic.Api.Domain.Guardrails.GuardrailSystemPolicy", null)
                        .WithMany()
                    ...
                    b.HasOne("Appostolic.Api.Domain.Guardrails.GuardrailTenantPolicy", null)
                        .WithMany()
                        .HasForeignKey("TenantPolicyId")
                        .OnDelete(DeleteBehavior.SetNull);
                });
